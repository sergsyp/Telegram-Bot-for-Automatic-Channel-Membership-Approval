...
- [x] 1.1 Add the five verified season-3 YouTube URLs and verify their episode mapping and URL uniqueness in unit tests
- [x] 1.2 Document season-3 external statistics coverage and verify README matches runtime behavior
